...
import { ProductsContainer, VehicleSection, ContainerPage } from "./style";
        ...
        <ProductsContainer>
          {vehicles!.length === 0 ? (
            <div className="list--cards__empty">
              <Text weight="500" className="heading6">
                Parece que ainda não existem veículos cadastrados
              </Text>
              <Text weight="500">Que tal criar seu primeiro anúncio?</Text>
            </div>
          ) : (
            <>
