  ...
  const { registerUser } = useContext(AuthContext);
	...
	return (
		<Container>
			<ContainerBox>
				...
				<FormContainer onSubmit={handleSubmit(registerUser)}>
					<section>
						...
						<Input type="text" title="Nome" placeholder="Ex: Samuel Leão" {...register("name")} />
						...
						/>
						{errors.birthdate && (
							<span className="error-message">{errors.birthdate.message?.toString()}</span>
						)}
						<Input
							type="text"
							title="Descrição"
					...
					<section>
						...
						<div className="input--box">
							<Input type="text" title="Estado" placeholder="Digitar Estado" {...register("state")} />
							<Input type="text" title="Cidade" placeholder="Digitar Cidade" {...register("city")} />
						</div>
						{(errors.state || errors.city) && (
							<span className="error-message">Estado e Cidade são obrigatórios</span>
						)}
						<Input type="text" title="Rua" placeholder="Digitar endereço" {...register("street")} />
						<div className="input--box">
							<Input type="text" title="Número" placeholder="Digitar número" {...register("number")} />
							<Input
								type="text"
								title="Complemento"
            ...
            {(errors.street || errors.number) && <span className="error-message">Rua e Número são obrigatórios</span>}
					</section>
					<section>
						<Text className="body2" weight="500">
							Tipo de conta
						...
						<div className="box--checkmark">
							<label className="form-control--radio">
								<input type="radio" value="true" {...register("userType")} defaultChecked />
            ...
            {errors.userType && <span className="error-message">{errors.userType.message?.toString()}</span>}
            <Input type="password" title="Senha" placeholder="Digitar Senha" {...register("password")} id="password" />
